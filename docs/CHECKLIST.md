...
- [x] Validation (2026-09-01): focused lease tests pass (reentry 8, edit_lease 16, edit_lease_route 7, client_edit_lease 12); full `npm test` 185 tests across 22 files all pass, `npm run typecheck` clean, `git diff --check 078659a..HEAD` 0
