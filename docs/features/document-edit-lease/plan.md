...
**Spec:** `docs/features/document-edit-lease/design.md`
...
**Files:**
- Existing uncommitted docs: `docs/project/implement_plan.md`
- Existing uncommitted spec: `docs/features/document-edit-lease/design.md`
- Existing uncommitted plan: `docs/features/document-edit-lease/plan.md`
...
```powershell
git diff --check
git add -- "docs/project/implement_plan.md" "docs/features/document-edit-lease/design.md" "docs/features/document-edit-lease/plan.md"
...
// Client heartbeat/poll intervals remain simple local timer values (2s/1s).
...
- Modify: `docs/features/document-edit-lease/design.md`
...
Add unchecked manual browser cases to `docs/project/CHECKLIST.md` because the user, not the Worker, will execute them. Do not mark browser E2E/manual cases complete.
...
```powershell
git add -- "README.md" "docs/project/CHECKLIST.md" "docs/features/document-edit-lease/design.md"
