...
Support sequential editing with a document-scoped single-editor lease, graceful takeover, and stale-write fencing. See [Document-Scoped Single-Editor Lease Requirements and Design](./superpowers/specs/2026-09-01-document-edit-lease-design.md).
...
The self-hosted options, recommended service boundary, and migration concerns are recorded in [Self-Hosted Excalidraw Collaboration Research](./SELF_HOSTED_COLLABORATION_RESEARCH.md).
